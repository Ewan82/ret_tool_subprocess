...
c
C     MVO::added implicit none
      implicit none
      INTEGER LAD,NV
C     MVO::switched 1000->NV in array declarator
      REAL BRF(NV)
      REAL THETA_V(NV),PHI_V(NV),THETA_I,PHI_I
c$$$      REAL BRF(1000)
c$$$      REAL THETA_V(1000),PHI_V(1000),THETA_I,PHI_I
...
C     MVO::n_c type changed
c$$$      real df,x_nf,a_f,n_c,h_c,x_ly,r 
