...
def make_exps_508med_arr_test(point='sg01', site='ita'):
    time_start = ['20170630']
    time_end = ['20171026']
    states_file = ['/home/users/if910917/projects/ret_tool_subprocess/state_files/retr_jules_prior.csv',
                   False]
    ...
    obs_s2 = ['/home/users/if910917/projects/ret_tool_subprocess/S2/'+site+'_s2_'+point+'_b4b8.csv',
              '/home/users/if910917/projects/ret_tool_subprocess/S2/'+site+'_s2_'+point+'_b4b5b6b7b8b8a.csv',
              '/home/users/if910917/projects/ret_tool_subprocess/S2/'+site+'_s2_'+point+'_allbands.csv',
              False
              ]
    #no_use_prior = [False, True]
    #no_use_states = [False, True]
...
def exp_run_setup(point='sg01', site='ita', run_retr=True):
    ...
    :return: na
    """
    exp_list = make_exps_508med_arr_test(point, site)
...
def find_good_exp(dir, exp_no='test'):
...
if __name__ == "__main__":
    exp_list = make_exps_508med_arr_test(sys.argv[2], sys.argv[3])
