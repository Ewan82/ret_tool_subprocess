...
class RetrievalSetup(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.s1_unc_db   = kwargs.get('s1_unc', 1.2)
        self.s2_relunc   = kwargs.get('s2_relunc', 0.1)
        self.s2_uncfloor = kwargs.get('s2_uncfloor', 0.005)
        ...
        self.dynmodunc_dct['sm']    = {'ndays_lst':[1,5],   'unc_lst':[0.1,0.2,.5]}
